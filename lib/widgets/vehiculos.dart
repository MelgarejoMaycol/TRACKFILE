...
class _VehiculosWidgetState extends State<VehiculosWidget> {
  ...
  Widget _buildVehicleDocumentsList(String plate, bool isCompact) {
    ...
    return Column(
      children: docs.map((d) {
        ...
        final String rutaArchivo = d['rutaArchivo']?.toString() ?? d['filePath']?.toString() ?? '';
  ...
  Widget _buildVehicleCard(_Vehicle vehicle, bool isCompact) {
    ...
    final List<Map<String, dynamic>> docs = _vehicleDocumentsByPlate[plate] ?? [];
    final int docCount = docs.length;
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(vehicle.placa, style: TextStyle(color: Colors.white, fontSize: isCompact ? 15 : 17, fontWeight: FontWeight.w700)),
                  ...
                  // PROPIETARIO - Mostrar siempre si tenemos datos
                  if (vehicle.nombrePropietario != null && vehicle.nombrePropietario!.isNotEmpty) ...[
                    // Encabezado Propietario
                    Row(
                      children: [
                        Icon(Icons.person, color: _successColor, size: 12),
                        const SizedBox(width: 4),
                        Expanded(
                          child: Text(
                            vehicle.nombrePropietario!,
                            style: TextStyle(color: _successColor, fontSize: isCompact ? 11 : 12, fontWeight: FontWeight.bold),
                            overflow: TextOverflow.ellipsis,
                          ),
                        ),
                      ],
                    ...
                    if (vehicle.telefonoPropietario != null && vehicle.telefonoPropietario!.isNotEmpty) ...[
                      ...
                      Row(
                        children: [
                          Icon(Icons.phone, color: _successColor, size: 9),
                          const SizedBox(width: 4),
                          Expanded(
                            child: Text(
                              vehicle.telefonoPropietario!,
                              style: TextStyle(color: _successColor, fontSize: isCompact ? 10 : 11),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ),
                        ],
                  ...
                  // CONDUCTOR - Mostrar siempre si tenemos datos
                  if (vehicle.nombreConductor != null && vehicle.nombreConductor!.isNotEmpty) ...[
                    // Encabezado Conductor
                    Row(
                      children: [
                        Icon(Icons.directions_car, color: Color(0xFF9D84FF), size: 12),
                        const SizedBox(width: 4),
                        Expanded(
                          child: Text(
                            vehicle.nombreConductor!,
                            style: TextStyle(color: Color(0xFF9D84FF), fontSize: isCompact ? 11 : 12, fontWeight: FontWeight.bold),
                            overflow: TextOverflow.ellipsis,
                          ),
                        ),
                      ],
                    ...
                    if (vehicle.telefonoConductor != null && vehicle.telefonoConductor!.isNotEmpty) ...[
                      ...
                      Row(
                        children: [
                          Icon(Icons.phone, color: Color(0xFF9D84FF), size: 9),
                          const SizedBox(width: 4),
                          Expanded(
                            child: Text(
                              vehicle.telefonoConductor!,
                              style: TextStyle(color: Color(0xFF9D84FF), fontSize: isCompact ? 10 : 11),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ),
                        ],
                  ...
                  // Color y Documentos en una sola fila compacta
                  if (vehicle.color != null && vehicle.color!.isNotEmpty || docCount > 0) ...[
                    Row(
                      children: [
                        if (vehicle.color != null && vehicle.color!.isNotEmpty) ...[
                          Icon(Icons.color_lens, color: _warningColor, size: 11),
                          const SizedBox(width: 3),
                          Expanded(
                            child: Text(
                              vehicle.color!,
                              style: TextStyle(color: _warningColor, fontSize: isCompact ? 10 : 11),
                              overflow: TextOverflow.ellipsis,
                            ),
                          ),
                          const SizedBox(width: 3),
                        ...
                        if (docCount > 0) ...[
                          Icon(Icons.description, color: _warningColor, size: 11),
                          const SizedBox(width: 3),
                          Text(
                            'Doc:$docCount',
                            style: TextStyle(color: _warningColor, fontSize: isCompact ? 10 : 11),
          ...
          Row(
            children: [
              ...
              PopupMenuButton<String>(
                onSelected: (value) {
                  if (value == 'documentos') {
                    _showDocumentsModal(vehicle, isCompact);
                  } else if (value == 'info') {
                    _showVehicleModal(vehicle, isCompact);
                  }
                },
                  ...
                  const PopupMenuItem<String>(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 12),
                        Text('Ver documentos', style: TextStyle(color: Colors.white)),
                      ],
                    ),
                  ),
                  const PopupMenuItem<String>(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 12),
                        Text('Más información', style: TextStyle(color: Colors.white)),
                      ],
                    ),
                  ),
                ],
                ...
                child: Container(
                  ...
                  child: const Icon(Icons.more_vert, color: Color(0xFF4F4CE8), size: 20),
                ),
              ),
            ],
          ),
